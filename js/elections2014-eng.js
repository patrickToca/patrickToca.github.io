    ...
    chart1.titles = [
        {
            "id": "Title-1",
            "size": 14,
            "text": "Abstention: forgotten or buried"
        },
        {
            "id": "Title-2",
            "size": 14,
            "text": "Results as they are presented."
        }
    ];
    ...
    chart2.titles = [
        {
            "id": "Title-1",
            "size": 14,
            "text": "The FACTS, never shown nor analyzed!"
        },
        {
            "id": "Title-2",
            "size": 14,
            "text": " Official results (with abstentions, 'blancs' and  'nuls' votes). "
        }
    ];
